  ...
  if (!data || data.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Enhanced Team Workload</h3>
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white dark:bg-gray-800 p-3 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Remaining: {payload[1].value} points</p>
          {memberData && (
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Enhanced Team Workload</h3>
          ...
          <div key={index} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
            <div className="flex justify-between items-start mb-3">
              <div className="flex items-center gap-2">
                <h4 className="font-medium text-gray-900 dark:text-white">{member.assignee}</h4>
              ...
              <div className="text-right">
                <div className="text-lg font-semibold text-gray-900 dark:text-white">{member.completion_rate}%</div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 text-sm">
              <div className="text-center">
                <div className="font-semibold text-gray-900 dark:text-white">{member.total_items}</div>
              ...
              <div className="text-center">
                <div className="font-semibold text-gray-600 dark:text-gray-400">{member.todo_items}</div>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center text-sm">
          ...
          <div>
            ...
            <div className="text-gray-600 dark:text-gray-400">Completed Points</div>
          </div>
          <div>
            <div className="text-lg font-bold text-red-600">
              {data.filter(m => m.workload_risk === 'high').length}
            </div>
            <div className="text-gray-600 dark:text-gray-400">High Risk Members</div>
          </div>
          <div>
